      ...
      <div className="bg-white rounded-3xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
        <div className="bg-green-800 p-12 text-white">
          ...
          <p className="text-green-100 mb-10">
            ¿Tienes dudas sobre el cuidado de tus plantas o buscas una especie
            en especial? Escríbenos y Cecilia te ayudará personalmente.
          </p>
          ...
          <div className="mt-12 flex space-x-4">
            <div className="w-10 h-10 border border-green-600 rounded-full flex items-center justify-center hover:bg-green-600 cursor-pointer transition-colors">
              f
            </div>
            <div className="w-10 h-10 border border-green-600 rounded-full flex items-center justify-center hover:bg-green-600 cursor-pointer transition-colors">
              ig
