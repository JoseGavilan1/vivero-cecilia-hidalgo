export function WhatsAppButton() {
  const telefono = "56912345678"; // Aquí pones el de tu madre
  const mensaje = "Hola Cecilia, vi tu página web y me gustaría consultar por unas plantas.";
