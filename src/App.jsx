    ...
    <div className="min-h-screen bg-[#F9F7F2] text-stone-800">
      ...
      <header className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          <span className="uppercase tracking-[0.3em] text-sm text-green-800 font-semibold mb-2 block">Curacaví, Chile</span>
          <h1 className="text-6xl md:text-8xl font-serif text-stone-900 mb-4">Vivero Cecilia</h1>
          <div className="h-1 w-24 bg-green-700 mx-auto rounded-full"></div>
          <p className="mt-6 text-xl text-stone-600 italic">"Donde la naturaleza se siente en casa"</p>
        </div>
      </header>

      {/* Catálogo por Categorías */}
      <main className="max-w-6xl mx-auto py-20 px-6">
        <h2 className="text-center text-4xl font-serif mb-20">Nuestro Catálogo</h2>
        {categorias.map(cat => (
      ...
      <footer className="bg-stone-900 text-stone-400 py-16 px-6 text-center">
        <h3 className="text-white text-2xl font-serif mb-4">Vivero Cecilia Hidalgo</h3>
        <p className="mb-8">Calle Principal S/N, Sector Los Naranjos, Curacaví.</p>
        <div className="flex justify-center space-x-6 mb-8 text-sm uppercase tracking-widest">
